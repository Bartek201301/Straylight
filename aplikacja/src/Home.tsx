...
function Home() {
  ...
  const heroButton = [
    { label: "Sprawdź nowy artykuł", href: "/artykuly" }
  ];
          ...
          <div className="max-w-6xl mx-auto transform translate-x-12">
            <div className="grid md:grid-cols-2 gap-0 items-center">
              ...
              <div className="h-[500px] flex flex-col justify-center space-y-6">
                ...
                {/* Przycisk do artykułów */}
                <div className="-ml-4">
                  <Link 
                    to="/artykuly"
                    className="inline-block px-6 py-3 bg-white text-black font-medium rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
                  >
                    Sprawdź nowy artykuł
                  </Link>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
                ...
                <p className="text-sm text-white/60 max-w-xl mx-auto leading-relaxed font-source">
                  ...
                  <button type="button" className="text-white hover:text-white/80 underline mx-1 bg-transparent border-none cursor-pointer">Polityką Prywatności</button>
                  Straylight.
                </p>
              </div>
            </div>
