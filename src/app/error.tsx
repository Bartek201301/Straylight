        ...
        <div className="max-w-lg w-full">
          <div className="card-base p-12 text-center">
            ...
            <div className="space-y-3">
              <button
                onClick={reset}
                className="w-full px-6 py-3 bg-ai-purple-600 hover:bg-ai-purple-700 text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-ai-purple-500 focus:ring-offset-2 focus:ring-offset-dark-800"
              >
                Try again
              </button>
